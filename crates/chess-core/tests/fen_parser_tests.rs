...
mod fen_parser_tests {
    use chess_core::{Color, PieceType, Position, Square};
    ...
    fn test_starting_position_fen() {
        ...
        assert_eq!(
            position
                .pieces_of_type(PieceType::Pawn, Color::White)
                .count_bits(),
            8
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::Pawn, Color::Black)
                .count_bits(),
            8
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::Rook, Color::White)
                .count_bits(),
            2
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::Rook, Color::Black)
                .count_bits(),
            2
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::Queen, Color::White)
                .count_bits(),
            1
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::Queen, Color::Black)
                .count_bits(),
            1
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::King, Color::White)
                .count_bits(),
            1
        );
        assert_eq!(
            position
                .pieces_of_type(PieceType::King, Color::Black)
                .count_bits(),
            1
        );
    ...
    fn test_fen_piece_placement_accuracy() {
        ...
        assert!(
            matches!(position.piece_at(a1), Some(piece) if piece.piece_type == PieceType::Rook && piece.color == Color::White)
        );
        assert!(
            matches!(position.piece_at(e1), Some(piece) if piece.piece_type == PieceType::King && piece.color == Color::White)
        );
        assert!(
            matches!(position.piece_at(h1), Some(piece) if piece.piece_type == PieceType::Rook && piece.color == Color::White)
        );
    }
}
